            ...
            <aside className="w-20 h-screen border-r-2" aria-label="Sidebar">
                <div className="overflow-y-auto py-4 px-3 bg-GLblack rounded">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/home" className="flex items-center justify-around p-2 my-3">
                        ...
                        <li>
                            <Link to="/explore" className="flex items-center justify-around p-2 my-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#f9f9f9" className="w-6 h-6">
                        ...
                        <li>
                            <Link to="/community" className="flex items-center justify-around p-2 my-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#f9f9f9" className="w-6 h-6">
                        ...
                        <li>
                            <Link to="/recently-played" className="flex items-center justify-around p-2 my-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#f9f9f9" className="w-6 h-6">
                        ...
                        <li>
                            <Link to="/account" className="flex items-center justify-around p-2 my-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#f9f9f9" className="w-6 h-6">
