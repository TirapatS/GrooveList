  ...
  return (
    <form onSubmit={(e) => handleSearch(e)}>   
        <div className="relative laptop:w-[52rem]">
            ...
            <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm rounded-xl bg-gray-500" required/>
            <button type="submit" className="text-GLwhite absolute right-2.5 bottom-2.5 bg-GLblack hover:bg-gray-600 font-body rounded-lg text-sm px-4 py-2">Search</button>
        </div>
    </form>
  )
}
