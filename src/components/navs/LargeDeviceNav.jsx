            ...
            <aside className="w-20 h--full-screen border-r-2 flex" aria-label="Sidebar">
                <div className="py-4 px-3 bg-GLblack rounded">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/favourites" className="flex items-center justify-around p-2 my-3 hover:bg-gray-600 hover:rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f9f9f9" className="w-6 h-6">
